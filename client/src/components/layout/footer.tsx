      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          <div>
            ...
            <p className="text-gray-400 mb-4">Your favorite food delivery service. Fresh, fast, and delicious meals delivered right to your door.</p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="text-gray-400 hover:text-white transition-colors">Delivery Driver</a></li>
        ...
        <div className="border-t border-gray-700 pt-8 text-center">
          <p className="text-gray-400">&copy; 2024 FoodieHub. All rights reserved. Made with ❤️ for food lovers.</p>
        </div>
      </div>
    </footer>
  );
